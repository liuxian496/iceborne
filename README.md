...
Iceborne，是一个简易版的，基于 Electron 开发的，支持 mac os 系统的弹幕播报应用，是一个纯前端的直播弹幕显示和播报工具。它的核心功能是「根据用户输入的网络链接」创建一个始终位于其他窗口之上的窗口。目前支持的云插件包括[bilibili 在线弹幕姬](https://link.bilibili.com/ctool/vtuber/)和[咩播云插件](https://yun.miebo.cn/)，B 站幻星-BLC。
